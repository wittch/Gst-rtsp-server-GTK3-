...
G_DEFINE_TYPE_WITH_PRIVATE (GstRTSPMountPoints, gst_rtsp_mount_points, G_TYPE_OBJECT);
...
{
  GstRTSPMountPointsPrivate *priv = gst_rtsp_mount_points_get_instance_private (mounts);
